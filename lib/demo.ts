...
export const DEMO_SERVICES: Service[] = [
  ...
  {
    id: "demo-brow-shape",
    name_en: "Brow Shaping",
    name_sv: "Brynformning",
    description_en: "Precise mapping and shaping to suit your features.",
    description_sv: "Exakt uppmätning och formning som passar dina drag.",
    duration_minutes: 20,
    price: 250,
    is_active: true,
    sort_order: 4,
  ...
  {
    id: "demo-brow-tint",
    name_en: "Brow Tint & Shape",
    name_sv: "Brynfärg & formning",
    description_en: "Shaping paired with a soft, natural tint.",
    description_sv: "Formning tillsammans med en mjuk, naturlig färg.",
    duration_minutes: 30,
    price: 350,
    is_active: true,
    sort_order: 5,
  ...
  },
  {
    ...
    name_sv: "Bryn-laminering",
    description_en: "Brushed-up, full brows that hold for weeks.",
    description_sv: "Uppborstade, fylliga bryn som håller i veckor.",
    duration_minutes: 45,
    price: 650,
    is_active: true,
    sort_order: 6,
